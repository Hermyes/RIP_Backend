...
SECRET_KEY = 'django-insecure-pjr4d(67z31$k98l5n*rmc50(3a$p4k%5z_8n08kp5_-s#9^et'
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    # },
    {
        ...
        'OPTIONS': {
            'min_length': 1,  # Минимальная длина пароля — 1 символ
        }
    },
    # {
...
# Minio configuration
AWS_STORAGE_BUCKET_NAME = 'dungeonsanddragonsphotos'
